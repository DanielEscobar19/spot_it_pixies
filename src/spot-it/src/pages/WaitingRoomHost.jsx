    ...
    <section className="container text-center">
      ...
      <div className="row align-items-end my-5">
        ...
        <div className="col d-flex justify-content-end">
          <Link state={{playersConnected : playersList, actualPlayer : playersList[0], sessionName : searchParams.get("session-name"), sessionPin : searchParams.get("session-pin")}} to={{
            pathname: "/game-room",
           }}> 
            <Button title="Start" /> 
          </Link>
